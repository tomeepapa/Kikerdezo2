...
public class testDb extends HttpServlet {
    ...
    @EJB
    private CommonController commonc;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<Words> szolista = commonc.getAllFromCateg(1);
            
              for (Words szo : szolista){
                  out.print(szo.getfMean());
                 
                  out.println();
                  out.print(szo.gethMean1());
                  out.println();
                  out.print(szo.gethMean2());
                  out.println();
                  out.println("<br/>");
              }
